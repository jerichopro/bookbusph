...
if (isset($updateUser)) {
 ...
 <div class="card ">
   <div class="card-header">
          <h3>Passenger Profile <span class="float-right"> <a href="index.php" class="btn btn-primary">Back</a> </h3>
        </div>
        <div class="card-body">
          ...
          <form class="" action="" method="POST">
              ...
              ">
                ...
                if($getUinfo->roleid == '1'){?>
                  ...
                  <option value="2">BusCompany</option>
                  <option value="3">Passenger</option>
                <?php }elseif($getUinfo->roleid == '2'){?>
                  <option value="1">Admin</option>
                  <option value="2" selected='selected'>BusCompany</option>
                  <option value="3">Passenger</option>
                <?php }elseif($getUinfo->roleid == '3'){?>
                  <option value="1">Admin</option>
                  <option value="2">BusCompany</option>
                  <option value="3" selected='selected'>Passenger</option>
